...
public class GNotThroughLineCondition implements GPlaneCondition {
    ...
    public boolean verify(Point3d[] cs, GDocument document) {
        ...
        n.normalize();
        return !GMath.isInPlane(coords[0], cs[0], n)
            || !GMath.isInPlane(coords[1], cs[0], n);
    }

    public void serialize(StringBuffer buf) {
        logger.info("");
        buf.append("\n<condition>");
        buf.append("\n<type>notThroughLine</type>");
    ...
    public String getDescription() {
        return GDictionary.get("NotThroughLine");
    }
}
