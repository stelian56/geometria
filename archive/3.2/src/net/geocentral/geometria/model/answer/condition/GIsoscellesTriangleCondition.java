...
public class GIsoscellesTriangleCondition implements GPlaneCondition, GFigureCondition {
    ...
    public boolean verify(Point3d[] cs, GDocument document) {
        ...
        return face.isIsoscellesTriangle(fragment);
    }
    ...
    public String getDescription() {
        return GDictionary.get("IsoscellesTriangle");
    }
