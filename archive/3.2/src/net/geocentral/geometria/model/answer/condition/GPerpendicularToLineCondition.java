...
public class GPerpendicularToLineCondition implements GPlaneCondition {
    ...
    public boolean verify(Point3d[] cs, GDocument document) {
        ...
        v.sub(coords[0]);
        v.normalize();
        return GMath.areCollinear(v, n, GMath.EPSILON);
    }
    ...
    public String getDescription() {
        return GDictionary.get("PerpendicularToLine");
    }
}
