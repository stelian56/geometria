...
public class GPerpendicularToPlaneCondition implements GPlaneCondition {
    ...
    public boolean verify(Point3d[] cs, GDocument document) {
        ...
        n2.normalize();
        return Math.abs(n1.dot(n2)) < GMath.EPSILON;
    }

    public void serialize(StringBuffer buf) {
        logger.info("");
        buf.append("\n<condition>");
        buf.append("\n<type>perpendicularToPlane</type>");
    ...
    public String getDescription() {
        return GDictionary.get("PerpendicularToPlane");
    }
}
