...
public class GRectangularTriangleCondition implements GPlaneCondition, GFigureCondition {
    ...
    public boolean verify(Point3d[] cs, GDocument document) {
        ...
        return face.isRectangularTriangle(fragment);
    }
    ...
    public String getDescription() {
        return GDictionary.get("RectangularTriangle");
    }
