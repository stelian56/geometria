...
public class GEraseLineDialog extends JDialog implements GHelpOkCancelDialog {

    private int option = CANCEL_OPTION;

    private GEraseLineAction action;
    ...
    public GEraseLineDialog(Frame ownerFrame, GEraseLineAction action) {
        ...
        setTitle(GDictionary.get("EraseLine"));
    }
    ...
    private void layoutComponents() {
        ...
        JPanel centerInputPane = GGraphicsFactory.getInstance()
            .createImagePane("/images/EraseLine.png");
