...
public class GPointSetFactory {

    private static GPointSetFactory instance;

    private static Logger logger = Logger.getLogger("net.geocentral.geometria");

    private GPointSetFactory() {}
    
    public static GPointSetFactory getInstance() {
        if (instance == null)
            instance = new GPointSetFactory();
        return instance;
    }
    
    public Point3d[] fromString(String s, String figureName,
            GDocument document) throws Exception {
        GFigure figure = document.getFigure(figureName);
        return fromString(s, figure);
    }
    
    public Point3d[] fromString(String s, GFigure figure) throws Exception {
    ...
    public String[] fromSelection(GDocument document) {
