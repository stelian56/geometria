...
public class GDodecahedronAction implements GLoggable {

    public static final String FILE = "/gallery/dodecahedron";
    ...
    public GLoggable clone() {
        GDodecahedronAction action = new GDodecahedronAction();
        action.figureName = figureName;
        return action;
    }

    public String toLogString() {
        return GDictionary.get("CreateDodecahedron", figureName);
    }
