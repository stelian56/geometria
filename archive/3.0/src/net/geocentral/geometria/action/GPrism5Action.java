...
public class GPrism5Action implements GLoggable, GFigureAction {
    ...
    public boolean execute(GDocumentHandler documentHandler,
        ...
        GSolid solid = GSolidFactory.getInstance().newPrism(5);
    ...
    public GLoggable clone() {
        GPrism5Action action = new GPrism5Action();
        action.figureName = figureName;
        return action;
    }

    public String toLogString() {
        return GDictionary.get("CreatePrism", "5", figureName);
    }
    ...
    public String getShortDescription() {
        return GDictionary.get("createPrism", "4");
    }
