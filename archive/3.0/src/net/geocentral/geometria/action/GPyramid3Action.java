...
public class GPyramid3Action implements GLoggable, GFigureAction {
    ...
    public boolean execute(GDocumentHandler documentHandler,
        ...
        GSolid solid = GSolidFactory.getInstance().newPyramid(3);
    ...
    public GLoggable clone() {
        GPyramid3Action action = new GPyramid3Action();
        action.figureName = figureName;
        return action;
    }

    public String toLogString() {
        return GDictionary.get("CreatePyramid", "3", figureName);
    }
    ...
    public String getShortDescription() {
        return GDictionary.get("createPyramid", "3");
    }
