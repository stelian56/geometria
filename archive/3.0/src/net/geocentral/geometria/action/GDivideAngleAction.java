...
public class GDivideAngleAction implements GLoggable, GFigureAction,
        GActionWithHelp {
    ...
    public boolean execute(GDocumentHandler documentHandler,
        ...
        if (quietMode) {
            ...
            GDivideAngleDialog dialog = new GDivideAngleDialog(
                    documentHandler.getOwnerFrame(), this, true);
    ...
    public void validateApply() throws Exception {
        ...
        if (faces.isEmpty()) {
            ...
            throw new Exception(GDictionary.get(
                "LinesDoNotBelongToSameFace", pLabels[0] + pLabels[1],
                pLabels[0] + pLabels[2], figureName));
        }
        ...
        Vector3d v = GMath.divideAngle(ps[0].coords, ps[1].coords,
                ps[2].coords, numerator
                / denominator);
        ...
        for (GLine line : lines) {
            ...
            if (!line.firstLabel().equals(pLabels[0])
                    && GMath.areCooriented(v1, v, epsilon)
                    || !line.lastLabel().equals(pLabels[0])
                    && GMath.areCooriented(v2, v, epsilon)) {
    ...
    public void undo(GDocumentHandler documentHandler) {
        ...
        solid.clearSelection();
        if (addedPoint != null) {
            Collection<GFace> faces = solid.facesThroughPoint(addedPoint
                    .getLabel());
    ...
    public String toLogString() {
        return GDictionary.get("DivideAngleInRatio", pLabels[1]
                + pLabels[0] + pLabels[2], numeratorString,
                denominatorString, figureName);
    }
