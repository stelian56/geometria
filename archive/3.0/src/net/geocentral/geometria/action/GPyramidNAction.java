...
public class GPyramidNAction implements GLoggable, GFigureAction {
    ...
    public boolean execute(GDocumentHandler documentHandler,
        ...
        GSolid solid = GSolidFactory.getInstance().newPyramid(sideCount);
    ...
    public GLoggable clone() {
        GPyramidNAction action = new GPyramidNAction();
    ...
    public String toLogString() {
        return GDictionary.get("CreatePyramid", String.valueOf(sideCount),
                figureName);
    }
