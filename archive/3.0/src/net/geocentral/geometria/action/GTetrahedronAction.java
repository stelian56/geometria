...
public class GTetrahedronAction implements GLoggable {

    public static final String FILE = "/gallery/tetrahedron";
    ...
    public GLoggable clone() {
        GTetrahedronAction action = new GTetrahedronAction();
        action.figureName = figureName;
        return action;
    }

    public String toLogString() {
        return GDictionary.get("CreateTetrahedron", figureName);
    }
