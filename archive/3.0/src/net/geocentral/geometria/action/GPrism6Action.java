...
public class GPrism6Action implements GLoggable, GFigureAction {
    ...
    public boolean execute(GDocumentHandler documentHandler,
        ...
        GSolid solid = GSolidFactory.getInstance().newPrism(6);
    ...
    public GLoggable clone() {
        GPrism6Action action = new GPrism6Action();
        action.figureName = figureName;
        return action;
    }

    public String toLogString() {
        return GDictionary.get("CreatePrism", "6", figureName);
    }
    ...
    public String getShortDescription() {
        return GDictionary.get("createPrism", "6");
    }
