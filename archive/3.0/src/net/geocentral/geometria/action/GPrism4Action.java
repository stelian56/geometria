...
public class GPrism4Action implements GLoggable, GFigureAction {
    ...
    public boolean execute(GDocumentHandler documentHandler,
        ...
        GSolid solid = GSolidFactory.getInstance().newPrism(4);
    ...
    public GLoggable clone() {
        GPrism4Action action = new GPrism4Action();
        action.figureName = figureName;
        return action;
    }

    public String toLogString() {
        return GDictionary.get("CreatePrism", "4", figureName);
    }
