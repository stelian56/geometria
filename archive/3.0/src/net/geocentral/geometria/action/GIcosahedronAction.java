...
public class GIcosahedronAction implements GLoggable {

    public static final String FILE = "/gallery/icosahedron";
    ...
    public GLoggable clone() {
        GIcosahedronAction action = new GIcosahedronAction();
        action.figureName = figureName;
        return action;
    }

    public String toLogString() {
        return GDictionary.get("CreateIcosahedron", figureName);
    }
