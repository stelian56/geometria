...
public class GPyramid4Action implements GLoggable, GFigureAction {
    ...
    public boolean execute(GDocumentHandler documentHandler,
        ...
        GSolid solid = GSolidFactory.getInstance().newPyramid(4);
    ...
    public GLoggable clone() {
        GPyramid4Action action = new GPyramid4Action();
        action.figureName = figureName;
        return action;
    }

    public String toLogString() {
        return GDictionary.get("CreatePyramid", "4", figureName);
    }
    ...
    public String getShortDescription() {
        return GDictionary.get("createPyramid", "4");
    }
