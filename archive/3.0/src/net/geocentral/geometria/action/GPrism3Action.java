...
public class GPrism3Action implements GLoggable, GFigureAction {
    ...
    public boolean execute(GDocumentHandler documentHandler,
        ...
        GSolid solid = GSolidFactory.getInstance().newPrism(3);
    ...
    public GLoggable clone() {
        GPrism3Action action = new GPrism3Action();
        action.figureName = figureName;
        return action;
    }

    public String toLogString() {
        return GDictionary.get("CreatePrism", "3", figureName);
    }
    ...
    public String getShortDescription() {
        return GDictionary.get("createPrism", "3");
    }
