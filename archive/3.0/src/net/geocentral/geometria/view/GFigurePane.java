...
public class GFigurePane extends JPanel {
    ...
    public void repositionViewport(double factor) {
        ...
        Point vpCenter = new Point(vpRect.x + vpRect.width / 2,
                vpRect.y + vpRect.height / 2);
        Point newVpCenter = new Point((int)(vpCenter.x * factor),
                (int)(vpCenter.y * factor));
        Point newVpPosition = new Point(newVpCenter.x - vpRect.width / 2,
                newVpCenter.y - vpRect.height / 2);
