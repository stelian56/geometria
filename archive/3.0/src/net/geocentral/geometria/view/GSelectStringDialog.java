...
public class GSelectStringDialog extends JDialog implements GOkCancelDialog {
    ...
    public GSelectStringDialog(JDialog owner, String[] fLabelStrings, String subtitle) {
        ...
        setTitle(GDictionary.get(GApplicationManager.getInstance().getApplicationName()));
    }
    ...
    private void layoutComponents(String[] fLabelStrings, String subtitle) {
        ...
        JPanel topPane =
            GGraphicsFactory.getInstance().createTitledBorderPane(subtitle);
        ...
        JPanel okCancelPane =
            GGraphicsFactory.getInstance().createOkCancelPane(this);
