...
public class GSolutionConditionAnswerDialog extends JDialog implements
        GHelpOkCancelDialog {
    ...
    private GConditionAnswer problemAnswer;
    ...
    public GSolutionConditionAnswerDialog(Frame ownerFrame, GSolution document,
            GSolutionAnswerAction action, GConditionAnswer problemAnswer) {
