...
import net.geocentral.geometria.action.GMeasureDistanceAction;
...
public class GMeasureDistanceDialog extends JDialog implements
GHelpOkCancelDialog {

    private int option = CANCEL_OPTION;

    private GMeasureDistanceAction action;
    ...
    public GMeasureDistanceDialog(Frame ownerFrame,
            GMeasureDistanceAction action) {
        ...
        setTitle(GDictionary.get("MeasureDistance"));
    }
    ...
    private void layoutComponents() {
        ...
        JPanel centerInputPane = GGraphicsFactory.getInstance()
            .createImagePane("/images/MeasureDistance.png");
    ...
    public void ok() {
        ...
        action.setInput(p1TextField.getText().trim(),
                p2TextField.getText().trim(), variableInputPane.getInput());
        try {
