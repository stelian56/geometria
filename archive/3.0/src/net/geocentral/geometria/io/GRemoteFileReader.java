...
public class GRemoteFileReader extends GRemoteFileHandler
    ...
    public GRemoteFileReader(Frame ownerFrame, URL baseUrl, String filePath) {
        super(baseUrl);
    ...
    public void selectFile() throws Exception {
        logger.info("");
        GFileChooser treeNodeChooser = new GFileChooser(docTreeElement,
                ownerFrame, filePath);
    ...
    public InputStream getInputStream() throws Exception {
        ...
        try {
            ...
            throw new Exception(
                    GDictionary.get("CannotReadRemoteFile", filePath));
        }
    }
