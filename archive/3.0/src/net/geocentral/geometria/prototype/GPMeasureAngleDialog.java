...
public class GPMeasureAngleDialog extends JDialog {

	public final Dimension size = new Dimension(280, 380);

	public GPMeasureAngleDialog(Frame owner, String title, boolean modal)
