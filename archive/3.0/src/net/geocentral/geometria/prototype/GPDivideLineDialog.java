...
public class GPDivideLineDialog extends JDialog {

	public final Dimension size = new Dimension(280, 308);

	public GPDivideLineDialog(Frame owner, String title, boolean modal)
