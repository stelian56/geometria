...
define([
    ...
    return {
        ...
        icon: "geometriaIcon24 geometriaIcon24Dodecahedron",

        label: dict.get("action.Dodecahedron"),
        
        execute: function() {
            var props = gallery.addFigure("dodecahedron");
        ...
        toLog: function(props) {
            ...
            return dict.get("NewDodecahedron", figureName);
        },
        
        toJson: function() {
            return {
                "action": "dodecahedronAction"
            };
        }
    };
});
